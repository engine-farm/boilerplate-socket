...
export class CharacterController
    ...
    objectType(): EngineFarm.EngineLayer.EngineObjectType {
        ...
        return (this._objectType = EngineFarm.EngineLayer.ObjectTypeManager.getByEntity(
            CharacterEntity
        ));
    }
                        ...
                        addActions: [
                            {
                                ...
                                timing: {
                                    type:
                                    EngineFarm.NetworkLayer.Events.SectorEvents
                        ...
                        addActions: [
                            {
                                ...
                                action: {
                                    operation: gameEvent.data.state
                                        ? EngineFarm.EngineLayer.EngineActionOperation.Add
                                        : EngineFarm.EngineLayer.EngineActionOperation
                                              .Remove,
                                    type:
                                        EventsGame.GeneratedActions
                                            .CharacterMovement,
    ...
    async onJoinWorld(
        ...
        if (gameState.characters.has(user.selectedIds.characterId)) {
            ...
            return {
                type: EngineFarm.NetworkLayer.Events.SectorEvents.SectorEvent.ObjectCreate,
                engineObject: {
    ...
    async onDisconnectWorld(
        ...
        if (gameState.characters.has(user.selectedIds.characterId)) {
            ...
            return {
                type: EngineFarm.NetworkLayer.Events.SectorEvents.SectorEvent.ObjectRemove,
                engineObject: {
                    type: this.objectType(),
                    elementId: user.selectedIds.characterId,
                },
